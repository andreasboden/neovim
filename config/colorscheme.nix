...
in
{
  ...
  highlightOverride = {
    ...
    Visual        = { fg = p.ok;       bg = p.bg; };
    VisualNOS     = { fg = p.ok;       bg = p.bg; };
    ...
    TabLineFill   = { bg = p.bg; };
    TabLineSel    = { fg = p.ok;       bg = p.bg; bold = true; };
    ...
    TelescopeSelection    = { fg = p.ok;    bg = p.bg; };
